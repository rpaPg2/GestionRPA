...
const EditUser = () => {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            try {
                const response = await axios.get(`https://gestion-rpa-backend.vercel.app/api/user-form-back?id=${userId}`);
        ...
        const fetchBots = async () => {
            try {
                const response = await axios.get(`https://gestion-rpa-backend.vercel.app/api/user-bots-noy-asign?id=${userId}`);
    ...
    const confirmAction = async () => {
        ...
        try {
            await axios.post(`https://gestion-rpa-backend.vercel.app/api/${action}`, {
                userId,
                botIds: selectedBots,
            });
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.put(`https://gestion-rpa-backend.vercel.app/api/user-edit-update`, {
                id: userId,
                username,
                password,
                role,
